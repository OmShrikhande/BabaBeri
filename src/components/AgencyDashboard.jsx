  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#1A1A1A]">
      <div className="p-6">
        ...
        {/* <section className="mb-8" aria-labelledby="agency-financial-heading">
          <div className="mb-6">
            <h2 id="agency-financial-heading" className="text-2xl font-bold text-white">Financial Overview</h2>
            <p className="text-gray-400 mt-1">Track your revenue, profits, and financial performance</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {financialCards.map((card, index) => (
              <FinancialMetricsCard
                key={`agency-financial-${index}`}
                title={card.title}
                value={card.value}
        ...
        {/* <section className="mb-8" aria-labelledby="agency-analytics-heading">
          <div className="mb-6">
            <h2 id="agency-analytics-heading" className="text-2xl font-bold text-white">Analytics & Insights</h2>
