      ...
      <div className="p-4 space-y-4 max-h-[600px] overflow-y-auto coin-scroll">
        {loading ? (
          ...
          requests.map((request) => {
            ...
            return (
              <div
                key={request.id || `${name}-${time}`}
                className="space-y-3 p-3 bg-[#121212] rounded-lg border border-gray-700 hover:border-gray-600 transition-colors duration-300"
              >
                <div className="flex items-center space-x-3">
                  <div className="relative">
                    ...
                    />
                    <div className="absolute -bottom-1 -right-1 w-3 h-3 bg-green-500 rounded-full border border-[#121212]" />
                  </div>
...
export default CashoutRequestsPanel;
