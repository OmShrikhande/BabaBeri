              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-800/30 rounded-xl p-4 border border-gray-700/50">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="text-xs text-gray-500 block">Device (static - not in api)</label>
                      <code className="text-[#ff7197] font-mono">{selectedHost.deviceid || "a1b2c3d4e5f67890123456789abcdef0"}</code>
                    </div>
                  </div>
                </div>
