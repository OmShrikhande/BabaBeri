...
import {
  ...
  X, RefreshCw, Download, AlertCircle, ChevronUp, ChevronDown, Info
} from 'lucide-react';
      ...
      <div className="min-h-full flex flex-col">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  VIP plans grant users special privileges in the app. Invisible Mode hides the user from public listings.
                  VIP a Friend allows users to grant VIP status to a set number of friends.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 bg-[#121212] rounded-lg border border-gray-700 overflow-hidden flex flex-col">
          <div className="p-4 border-b border-gray-700">
            <h2 className="text-lg font-semibold text-white">VIP Plans</h2>
          </div>
