...
const AdminFinancialPage = () => {
  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      ...
      try {
        ...
        const res = adminCode
          ? await authService.getAllSubUserByCode(adminCode, 'MASTER_AGENCY')
          : { success: true, data: [] };
        if (!ignore && res.success) {
          setMasterAgencies(Array.isArray(res.data) ? res.data : []);
        }
      } catch (e) {
        console.error(e);
      } finally {
  ...
  return (
    <div className="p-6 space-y-8 bg-black/70 h-full w-full">
      ...
      {/* Financial Cards */}
      <section aria-labelledby="admin-fin-heading">
        <h2 id="admin-fin-heading" className="text-lg font-semibold text-white mb-4">Revenue Breakdown</h2>
      ...
      <section aria-labelledby="admin-analytics-heading">
        <h2 id="admin-analytics-heading" className="text-lg font-semibold text-white mb-4">Analytics & Insights</h2>
      ...
      {/* <section aria-labelledby="admin-table-heading">
        <h2 id="admin-table-heading" className="text-lg font-semibold text-white mb-4">Master Agencies</h2>
