...
const AgencyFinancialPage = () => {
  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      ...
      try {
        ...
        if (!ignore && hostsResponse.success) {
          const allHosts = Array.isArray(hostsResponse.data) ? hostsResponse.data : [];
          setHosts(allHosts.filter(h => h.owner === myCode));
        }
      } catch (e) {
        console.error(e);
      } finally {
  ...
  return (
    <div className="p-6 space-y-8 bg-black/70 min-h-full">
      ...
      {/* Financial Cards */}
      <section aria-labelledby="ag-fin-heading">
        <h2 id="ag-fin-heading" className="text-lg font-semibold text-white mb-4">Revenue Breakdown</h2>
      ...
      {/* Analytics & Insights */}
      <section aria-labelledby="ag-analytics-heading">
        <h2 id="ag-analytics-heading" className="text-lg font-semibold text-white mb-4">Analytics & Insights</h2>
      ...
      {/* Goals */}
      {/* <section aria-labelledby="ag-goals-heading">
        <h2 id="ag-goals-heading" className="text-lg font-semibold text-white mb-4">My Goals</h2>
        <AgencyGoals />
      </section> */}

      {/* Hosts Table */}
      {/* <section aria-labelledby="ag-table-heading">
        <h2 id="ag-table-heading" className="text-lg font-semibold text-white mb-4">My Hosts</h2>
...
export default AgencyFinancialPage;
